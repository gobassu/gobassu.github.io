...
Markdown을 사용하는 방법을 참고하기 위해 인용된 문서입니다. 
-------------------------------------------------------
...
* 깃헙([https://github.com](https://github.com)) Repository에 관한 정보를 기록하는 README.md 주로 사용 
...
# P.S.
[Notion](https://www.notion.so/product) 사용 검토 중 
